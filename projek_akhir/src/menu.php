    ...
    <section class="menu" id="menu">
        ...
        <?php if ($_SESSION['role'] == 1) {  ?>
            <div class="d-pesan-menu">
                <a href="" style="display: flex; align-items: center; gap: 0.5rem" class="btn-primary"><img style="filter: invert(100%);" src="../assets/icon/bootstrap-icons/fast-forward-circle.svg"> Pesan Menu</a>
            </div>
        <?php } ?>
    </section>
<?php } ?>
